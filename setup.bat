...
:: {"media.eme.enabled":{"Value":false,"Status":"locked"},"media.gmp-widevinecdm.enabled":{"Value":false,"Status":"locked"},"network.http.sendRefererHeader":{"Value":0,"Status":"locked"},"accessibility.blockautorefresh":{"Value":false,"Status":"locked"},"accessibility.force_disabled":{"Value":1,"Status":"locked"},"accessibility.typeaheadfind":{"Value":false,"Status":"locked"},"accessibility.typeaheadfind.autostart":{"Value":false,"Status":"locked"},"accessibility.typeaheadfind.enablesound":{"Value":false,"Status":"locked"},"accessibility.typeaheadfind.flashBar":{"Value":0,"Status":"locked"},"accessibility.typeaheadfind.manual":{"Value":false,"Status":"locked"},"browser.aboutConfig.showWarning":{"Value":false,"Status":"default"},"browser.aboutwelcome.enabled":{"Value":false,"Status":"locked"},"browser.backspace_action":{"Value":2,"Status":"locked"},"browser.contentblocking.report.hide_lockwise_app":{"Value":true,"Status":"locked"},"browser.contentblocking.report.hide_vpn_banner":{"Value":true,"Status":"locked"},"browser.contentblocking.report.lockwise.enabled":{"Value":false,"Status":"locked"},"browser.contentblocking.report.monitor.enabled":{"Value":false,"Status":"locked"},"browser.contentblocking.report.show_mobile_app":{"Value":false,"Status":"locked"},"browser.contentblocking.report.vpn-android.url":{"Value":"","Status":"locked"},"browser.contentblocking.report.vpn-ios.url":{"Value":"","Status":"locked"},"browser.contentblocking.report.vpn-promo.url":{"Value":"","Status":"locked"},"browser.contentblocking.report.vpn.enabled":{"Value":false,"Status":"locked"},"browser.contentblocking.report.vpn.url":{"Value":"","Status":"locked"},"browser.contentblocking.report.vpn_platforms":{"Value":"","Status":"locked"},"browser.contentblocking.report.vpn_regions":{"Value":"","Status":"locked"},"browser.contentblocking.report.vpn_sub_id":{"Value":"","Status":"locked"},"browser.crashReports.unsubmittedCheck.autoSubmit":{"Value":false,"Status":"locked"},"browser.crashReports.unsubmittedCheck.autoSubmit2":{"Value":false,"Status":"locked"},"browser.crashReports.unsubmittedCheck.enabled":{"Value":false,"Status":"locked"},"browser.ctrlTab.recentlyUsedOrder":{"Value":false,"Status":"locked"},"browser.ctrlTab.sortByRecentlyUsed":{"Value":false,"Status":"locked"},"browser.download.alwaysOpenPanel":{"Value":true,"Status":"locked"},"browser.download.always_ask_before_handling_new_types":{"Value":true,"Status":"locked"},"browser.download.autohideButton":{"Value":false,"Status":"locked"},"browser.download.improvements_to_download_panel":{"Value":false,"Status":"locked"},"browser.download.panel.shown":{"Value":true,"Status":"default"},"browser.download.start_downloads_in_tmp_dir":{"Value":true,"Status":"locked"},"browser.formfill.enable":{"Value":false,"Status":"default"},"browser.helperApps.neverAsk.openFile":{"Value":"","Status":"locked"},"browser.helperApps.neverAsk.saveToDisk":{"Value":"","Status":"locked"},"browser.helperApps.showOpenOptionForPdfJS":{"Value":true,"Status":"locked"},"browser.helperApps.showOpenOptionForViewableInternally":{"Value":true,"Status":"locked"},"browser.messaging-system.whatsNewPanel.enabled":{"Value":false,"Status":"locked"},"browser.newtabpage.activity-stream.asrouter.providers.whats-new-panel":{"Value":"{\"id\":\"whats-new-panel\",\"enabled\":false,\"type\":\"remote-settings\",\"collection\":\"whats-new-panel\",\"updateCycleInMs\":3600000}\"}","Status":"locked"},"browser.newtabpage.activity-stream.asrouter.userprefs.cfr.addons":{"Value":false,"Status":"locked"},"browser.newtabpage.activity-stream.asrouter.userprefs.cfr.features":{"Value":false,"Status":"locked"},"browser.newtabpage.activity-stream.default.sites":{"Value":"","Status":"locked"},"browser.newtabpage.activity-stream.discoverystream.newSponsoredLabel.enabled":{"Value":false,"Status":"locked"},"browser.newtabpage.activity-stream.discoverystream.spocs.personalized":{"Value":false,"Status":"locked"},"browser.newtabpage.activity-stream.discoverystream.sponsored-collections.enabled":{"Value":false,"Status":"locked"},"browser.newtabpage.activity-stream.feeds.aboutpreferences":{"Value":false,"Status":"locked"},"browser.newtabpage.activity-stream.feeds.discoverystreamfeed":{"Value":false,"Status":"locked"},"browser.newtabpage.activity-stream.feeds.favicon":{"Value":false,"Status":"locked"},"browser.newtabpage.activity-stream.feeds.newtabinit":{"Value":false,"Status":"locked"},"browser.newtabpage.activity-stream.feeds.places":{"Value":false,"Status":"locked"},"browser.newtabpage.activity-stream.feeds.recommendationproviderswitcher":{"Value":false,"Status":"locked"},"browser.newtabpage.activity-stream.feeds.section.highlights":{"Value":false,"Status":"locked"},"browser.newtabpage.activity-stream.feeds.section.topstories":{"Value":false,"Status":"locked"},"browser.newtabpage.activity-stream.feeds.sections":{"Value":false,"Status":"locked"},"browser.newtabpage.activity-stream.feeds.snippets":{"Value":false,"Status":"locked"},"browser.newtabpage.activity-stream.feeds.telemetry":{"Value":false,"Status":"locked"},"browser.newtabpage.activity-stream.feeds.telemetrybrowser.newtabpage.activity-stream.telemetry":{"Value":false,"Status":"locked"},"browser.newtabpage.activity-stream.feeds.topsites":{"Value":false,"Status":"locked"},"browser.newtabpage.activity-stream.improvesearch.topSiteSearchShortcuts":{"Value":false,"Status":"locked"},"browser.newtabpage.activity-stream.improvesearch.topSiteSearchShortcuts.havePinned":{"Value":"","Status":"locked"},"browser.newtabpage.activity-stream.improvesearch.topSiteSearchShortcuts.searchEngines":{"Value":"","Status":"locked"},"browser.newtabpage.activity-stream.section.highlights.includeBookmarks":{"Value":false,"Status":"locked"},"browser.newtabpage.activity-stream.section.highlights.includeDownloads":{"Value":false,"Status":"locked"},"browser.newtabpage.activity-stream.section.highlights.includePocket":{"Value":false,"Status":"locked"},"browser.newtabpage.activity-stream.section.highlights.includeVisited":{"Value":false,"Status":"locked"},"browser.newtabpage.activity-stream.showSearch":{"Value":false,"Status":"locked"},"browser.newtabpage.activity-stream.showSponsored":{"Value":false,"Status":"locked"},"browser.newtabpage.activity-stream.showSponsoredTopSites":{"Value":false,"Status":"locked"},"browser.newtabpage.activity-stream.telemetry":{"Value":false,"Status":"locked"},"browser.ping-centre.log":{"Value":false,"Status":"locked"},"browser.ping-centre.telemetry":{"Value":false,"Status":"locked"},"browser.pingcentre.telemetry":{"Value":false,"Status":"locked"},"browser.preferences.moreFromMozilla":{"Value":false,"Status":"locked"},"browser.privateWindowSeparation.enabled":{"Value":false,"Status":"locked"},"browser.privatebrowsing.infoEnabled":{"Value":false,"Status":"locked"},"browser.privatebrowsing.promoEnabled":{"Value":false,"Status":"locked"},"browser.privatebrowsing.vpnpromourl":{"Value":"","Status":"locked"},"browser.promo.cookiebanners.enabled":{"Value":false,"Status":"locked"},"browser.promo.focus.enabled":{"Value":false,"Status":"locked"},"browser.promo.pin.enabled":{"Value":false,"Status":"locked"},"browser.safebrowsing.malware.enabled":{"Value":true,"Status":"locked"},"browser.safebrowsing.phishing.enabled":{"Value":true,"Status":"locked"},"browser.search.context.loadInBackground":{"Value":true,"Status":"locked"},"browser.search.hiddenOneOffs":{"Value":"Google,Amazon.com,Bing,DuckDuckGo,eBay,Wikipedia (en)","Status":"locked"},"browser.search.log":{"Value":false,"Status":"locked"},"browser.search.suggest.enabled":{"Value":false,"Status":"locked"},"browser.search.suggest.enabled.private":{"Value":false,"Status":"locked"},"browser.send_pings":{"Value":false,"Status":"locked"},"browser.sessionstore.resume_from_crash":{"Value":false,"Status":"locked"},"browser.sessionstore.resuming_after_os_restart":{"Value":false,"Status":"locked"},"browser.startup.page":{"Value":1,"Status":"locked"},"browser.tabs.crashReporting.includeURL":{"Value":false,"Status":"locked"},"browser.tabs.crashReporting.sendReport":{"Value":false,"Status":"locked"},"browser.tabs.firefox-view":{"Value":false,"Status":"locked"},"browser.tabs.loadBookmarksInBackground":{"Value":true,"Status":"locked"},"browser.tabs.loadDivertedInBackground":{"Value":true,"Status":"locked"},"browser.tabs.loadInBackground":{"Value":true,"Status":"locked"},"browser.tabs.tabmanager.enabled":{"Value":false,"Status":"locked"},"browser.tabs.warnOnClose":{"Value":false,"Status":"default"},"browser.tabs.warnOnCloseOtherTabs":{"Value":false,"Status":"default"},"browser.taskbar.previews.enable":{"Value":false,"Status":"locked"},"browser.theme.dark-private-windows":{"Value":false,"Status":"locked"},"browser.uitour.enabled":{"Value":false,"Status":"locked"},"browser.uitour.surveyDuration":{"Value":0,"Status":"locked"},"browser.urlbar.addons.featureGate":{"Value":false,"Status":"locked"},"browser.urlbar.autoFill":{"Value":false,"Status":"locked"},"browser.urlbar.autoFill.adaptiveHistory.enabled":{"Value":false,"Status":"locked"},"browser.urlbar.contextualSearch.enabled":{"Value":false,"Status":"locked"},"browser.urlbar.eventTelemetry.enabled":{"Value":false,"Status":"locked"},"browser.urlbar.groupLabels.enabled":{"Value":false,"Status":"locked"},"browser.urlbar.maxRichResults":{"Value":0,"Status":"locked"},"browser.urlbar.quicksuggest.allowPositionInSuggestions":{"Value":false,"Status":"locked"},"browser.urlbar.quicksuggest.blockingEnabled":{"Value":false,"Status":"locked"},"browser.urlbar.quicksuggest.dataCollection.enabled":{"Value":false,"Status":"locked"},"browser.urlbar.quicksuggest.enabled":{"Value":false,"Status":"locked"},"browser.urlbar.quicksuggest.impressionCaps.nonSponsoredEnabled":{"Value":false,"Status":"locked"},"browser.urlbar.quicksuggest.impressionCaps.sponsoredEnabled":{"Value":false,"Status":"locked"},"browser.urlbar.quicksuggest.remoteSettings.enabled":{"Value":false,"Status":"locked"},"browser.urlbar.quicksuggest.scenario":{"Value":"offline","Status":"locked"},"browser.urlbar.quicksuggest.shouldShowOnboardingDialog":{"Value":false,"Status":"locked"},"browser.urlbar.quicksuggest.showOnboardingDialogAfterNRestarts":{"Value":0,"Status":"locked"},"browser.urlbar.richSuggestions.tail":{"Value":false,"Status":"locked"},"browser.urlbar.shortcuts.bookmarks":{"Value":false,"Status":"default"},"browser.urlbar.shortcuts.history":{"Value":false,"Status":"default"},"browser.urlbar.shortcuts.tabs":{"Value":false,"Status":"default"},"browser.urlbar.showSearchSuggestionsFirst":{"Value":false,"Status":"locked"},"browser.urlbar.showSearchTerms.enabled":{"Value":false,"Status":"locked"},"browser.urlbar.showSearchTerms.featureGate":{"Value":false,"Status":"locked"},"browser.urlbar.speculativeConnect.enabled":{"Value":false,"Status":"locked"},"browser.urlbar.sponsoredTopSites":{"Value":false,"Status":"locked"},"browser.urlbar.suggest.addons":{"Value":false,"Status":"locked"},"browser.urlbar.suggest.bestmatch":{"Value":false,"Status":"locked"},"browser.urlbar.suggest.bookmark":{"Value":false,"Status":"locked"},"browser.urlbar.suggest.calculator":{"Value":false,"Status":"locked"},"browser.urlbar.suggest.engines":{"Value":false,"Status":"locked"},"browser.urlbar.suggest.history":{"Value":false,"Status":"locked"},"browser.urlbar.suggest.openpage":{"Value":false,"Status":"locked"},"browser.urlbar.suggest.pocket":{"Value":false,"Status":"locked"},"browser.urlbar.suggest.quicksuggest":{"Value":false,"Status":"locked"},"browser.urlbar.suggest.quicksuggest.nonsponsored":{"Value":false,"Status":"locked"},"browser.urlbar.suggest.quicksuggest.sponsored":{"Value":false,"Status":"locked"},"browser.urlbar.suggest.remotetab":{"Value":false,"Status":"locked"},"browser.urlbar.suggest.searches":{"Value":false,"Status":"locked"},"browser.urlbar.suggest.topsites":{"Value":false,"Status":"locked"},"browser.urlbar.suggest.weather":{"Value":false,"Status":"locked"},"browser.urlbar.trimURLs":{"Value":false,"Status":"locked"},"browser.urlbar.update1.interventions":{"Value":false,"Status":"locked"},"browser.urlbar.update1.searchTips":{"Value":false,"Status":"locked"},"browser.vpn_promo.enabled":{"Value":false,"Status":"locked"},"datareporting.policy.dataSubmissionPolicyBypassNotification":{"Value":true,"Status":"locked"},"dom.battery.enabled":{"Value":false,"Status":"locked"},"dom.payments.defaults.saveAddress":{"Value":false,"Status":"default"},"dom.payments.defaults.saveCreditCard":{"Value":false,"Status":"default"},"extensions.allowPrivateBrowsingByDefault":{"Value":true,"Status":"locked"},"extensions.blocklist.enabled":{"Value":true,"Status":"locked"},"extensions.experiments.enabled":{"Value":false,"Status":"locked"},"extensions.formautofill.addresses.enabled":{"Value":false,"Status":"default"},"extensions.formautofill.creditCards.enabled":{"Value":false,"Status":"default"},"extensions.getAddons.showPane":{"Value":false,"Status":"locked"},"extensions.htmlaboutaddons.discover.enabled":{"Value":false,"Status":"locked"},"extensions.htmlaboutaddons.recommendations.enabled":{"Value":false,"Status":"locked"},"extensions.pocket.api":{"Value":"","Status":"locked"},"extensions.pocket.onSaveRecs":{"Value":false,"Status":"locked"},"extensions.pocket.onSaveRecs.locales":{"Value":"","Status":"locked"},"extensions.pocket.showHome":{"Value":false,"Status":"locked"},"extensions.pocket.site":{"Value":"","Status":"locked"},"extensions.unifiedExtensions.enabled":{"Value":false,"Status":"default"},"geo.enabled":{"Value":false,"Status":"locked"},"geo.provider.ms-windows-location":{"Value":false,"Status":"locked"},"media.hardwaremediakeys.enabled":{"Value":false,"Status":"default"},"media.navigator.enabled":{"Value":false,"Status":"default"},"media.videocontrols.picture-in-picture.keyboard-controls.enabled":{"Value":true,"Status":"default"},"media.videocontrols.picture-in-picture.video-toggle.enabled":{"Value":false,"Status":"default"},"media.wmf.deblacklisting-for-telemetry-in-gpu-process":{"Value":false,"Status":"locked"},"network.IDN_show_punycode":{"Value":true,"Status":"locked"},"network.predictor.enable-prefetch":{"Value":false,"Status":"locked"},"network.predictor.enabled":{"Value":false,"Status":"locked"},"network.prefetch-next":{"Value":false,"Status":"locked"},"pdfjs.enableScripting":{"Value":false,"Status":"locked"},"print.always_print_silent":{"Value":false,"Status":"locked"},"print.save_print_settings":{"Value":false,"Status":"locked"},"print.tab_modal.enabled":{"Value":true,"Status":"locked"},"security.insecure_connection_text.enabled":{"Value":true,"Status":"locked"},"security.insecure_connection_text.pbmode.enabled":{"Value":true,"Status":"locked"},"security.mixed_content.block_active_content":{"Value":true,"Status":"locked"},"security.warn_submit_secure_to_insecure":{"Value":true,"Status":"locked"},"signon.autofillForms":{"Value":false,"Status":"default"},"toolkit.legacyUserProfileCustomizations.stylesheets":{"Value":true,"Status":"user"},"ui.key.menuAccessKeyFocuses":{"Value":false,"Status":"locked"}}
...
REG ADD "HKLM\SOFTWARE\Policies\Microsoft\Edge\ExtensionInstallAllowlist" /V 5 /T REG_SZ /D enamippconapkdmgfgjchkhakpfinmaj /F
